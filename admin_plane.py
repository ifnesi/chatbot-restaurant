...
from utils import create_topic, delivery_report
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        dest="config",
        type=str,
        help="Select config filename (default: config/localhost.ini)",
    ...
    parser.add_argument(
        ...
        dest="config_data",
        type=str,
        help="Select config filename for the data to be produced",
        required=True,
    )
