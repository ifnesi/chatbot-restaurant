...
from utils import (
    TOPIC_CUSTOMER_ACTIONS_EMBEDDINGS,
...
if __name__ == "__main__":
    ...
    with open(os.path.join("schemas", "chatbot_responses.avro"), "r") as f:
        schema_str = f.read()
                ...
                if mid == 0:  # Initial message (after login)
                    ...
                    if query:
                        ...
                        result_search = VDB_CLIENT.search(
                            collection_name=VDB_COLLECTION,
                            query_vector=value["vector"],  # Vector/Embeddings generated by ksqlDB
